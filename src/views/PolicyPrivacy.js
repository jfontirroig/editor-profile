...
class PolicyPrivacy extends Component {
  ...
  render() {
       ...
       Paradigma Global ("us", "we", or "our") operates the https://xck.app website.

       This page informs you of our policies regarding the collection, use and disclosure of personal data when you use our Service and the choices you have
       ...
       policy. Unless otherwise defined in this Privacy Policy, the terms used in this Privacy Policy have the same meanings as in our Terms and Conditions.

       1. Definitions

          1.1 Service

              Service means the https://xck.app website.
          ...
          1.3 Usage Data
              Usage Data is data collected automatically either generated by the use of the Service or from the Service infrastructure itself (for example,
          ...
          1.6 Data Processors (or Service Providers)

              Data Processor (or Service Provider) means any natural or legal person who processes the data on behalf of the Data Controller.
              We may use the services of various Service Providers in order to process your data more effectively.

          1.7 Data Subject (or User)
       ...
       2. Information Collection and Use
          ...
          2.1 Types of Data Collected
              ...
              2.1.2 Usage Data
                    ...
                    When you access the Service with a mobile device, this Usage Data may include information such as the type of mobile device you use, your
                    mobile device unique ID, the IP address of your mobile device, your mobile operating system, the type of mobile Internet browser you use,
          ...
          2.2 Tracking & Cookies Data
              ...
              Cookies are files with a small amount of data which may include an anonymous unique identifier. Cookies are sent to your browser from a website
              and stored on your device.

              Other tracking technologies are also used such as beacons, tags and scripts to collect and track information and to improve and analyse our
              Service.
       ...
       3. Use of Data
          ...
          Paradigma Global uses the collected data for various purposes:
       ...
       4. Legal Basis for Processing Personal Data under the General Data Protection Regulation (GDPR)
          ...
          If you are from the European Economic Area (EEA), Paradigma Global legal basis for collecting and using the personal information described in this
          Privacy Policy depends on the Personal Data we collect and the specific context in which we collect it.

          Paradigma Global may process your Personal Data because:
       ...
       5. Retention of Data
          ...
          Paradigma Global will retain your Personal Data only for as long as is necessary for the purposes set out in this Privacy Policy. We will
          retain and use your Personal Data to the extent necessary to comply with our legal obligations (for example, if we are required to retain your
          data to comply with applicable laws), resolve disputes and enforce our legal agreements and policies.

          Paradigma Global will also retain Usage Data for internal analysis purposes. Usage Data is generally retained for a shorter period of time,
          except when this data is used to streng then the security or to improve the functionality of our Service, or we are legally obligated to retain
       ...
       6. Transfer of Data
          ...
          Paradigma Global will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this
          Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls
          in place including the security of your data and other personal information.

       7. Disclosure of Data

          7.1 Legal Requirements
              Paradigma Global may disclose your Personal Data in the good faith belief that such action is necessary to:

                  - To comply with a legal obligation
                  - To protect and defend the rights or property of Paradigma Global
       ...
       9. Our Policy on "Do Not Track" Signals under the California Online Protection Act (CalOPPA)
          ...
          We do not support Do Not Track ("DNT"). Do Not Track is a preference you can set in your web browser to inform websites that you do not
          want to be tracked.
       ...
       10. Your Data Protection Rights under the General Data Protection Regulation (GDPR)
           ...
           If you are a resident of the European Economic Area (EEA), you have certain data protection rights. Paradigma Global aims to take
           ...
           In certain circumstances, you have the following data protection rights:
                  ...
                  - The right to access, update or delete the information we have on you. Whenever made possible, you can access, update or request
                    deletion of your Personal Data
                    directly within your account settings section. If you are unable to perform these actions yourself, please contact us to assist
                    you.
                  - The right of rectification. You have the right to have your information rectified if that information is inaccurate or incomplete.
                  - The right to object. You have the right to object to our processing of your Personal Data.
                  - The right of restriction. You have the right to request that we restrict the processing of your personal information.
                  - The right to data portability. You have the right to be provided with a copy of the information we have on you in a structured,
                    machine-readable and commonly used format.
                  - The right to withdraw consent. You also have the right to withdraw your consent at any time where Paradigma Global relied on your
       ...
       11. Service Providers
           ...
           These third parties have access to your Personal Data only to perform these tasks on our behalf and are obligated not to disclose or use
       ...
       15. Contact Us
           ...
           By email: info@paradigma.global `;

       let titleX = "Privacy Policy"
       let subtitleX = "Review"
       if (this.state.language === 'English'){
         titleX = "Privacy Policy"
         subtitleX = "Review"
       }
       if (this.state.language === 'French'){
         titleX = "Politique de confidentialité"
         subtitleX = "Review"
       }
       if (this.state.language === 'Spanish'){
         titleX = "Política de privacidad"
         subtitleX = "Revisar"
       }
       if (this.state.language === 'Portuguese'){
         titleX = "Política de Privacidade"
         subtitleX = "Revisão"
       }
       if (this.state.language === 'Swedish'){
         titleX = "Integritetspolicy"
         subtitleX = "Review"
       }
       if (this.state.language === 'Netherlands'){
         titleX = "Privacybeleid"
         subtitleX = "Recensie"
       }
       if (this.state.language === 'Russian'){
         titleX = "Политика конфиденциальности"
         subtitleX = "обзор"
       }
       ...
       if (this.state.language === 'German'){
         titleX = "Datenschutzerklärung"
         subtitleX = "Rückblick"
       }
       if (this.state.language === 'Italian'){
         titleX = "Informativa sulla privacy"
